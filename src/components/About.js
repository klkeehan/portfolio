...
const AboutPage = () => {
    return (
        <motion.div className='container2' initial={{opacity: 0, scale: 0.5}} animate={{opacity: 1, scale: 1}}>
            <h1>Hi! I'm Karissa, a digital media student at University of Central Florida. I'm studying web design
            through both coding with HTML, Javascript, CSS, PHP, and React, and using no-code programs like Webflow and WordPress.
            ...
            Thank you for visiting my portfolio :)</h1>
        </motion.div>
    );
};
